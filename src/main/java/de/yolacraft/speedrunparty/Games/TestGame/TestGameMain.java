package de.yolacraft.speedrunparty.Games.TestGame;
...
public class TestGameMain implements GameMain {

    private String world = "TESTGAME";
    ...
    public void start() {
        ...
        BrodcastMessage.sendBrodcastMessageWithPrefix(ChatColor.YELLOW + "Test Game");
        BrodcastMessage.sendBrodcastMessageWithPrefix(ChatColor.GRAY + "get as high as possible in 30 Seconds!");
        ...
        Runnables.runLater(80+30*20, () -> {
            ...
            Runnables.runLater(140, () -> {
                SpeedrunParty.getMainController().Next();
            });
    ...
    private void updateScores() {
        ...
        results.forEach(resultType -> {
            resultType.setScore((int) Math.round(resultType.getPlayer().getLocation().getY()));
        });
